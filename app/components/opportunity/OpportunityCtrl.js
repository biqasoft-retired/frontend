...
angular.module('app.opportunity', ['ngRoute', 'LocalStorageModule'])
    .controller('OpportunityAllCtrl', ['$scope', '$rootScope', 'LeadGenService', 'opportunityService', 'SystemService',
        function($scope, $rootScope, LeadGenService, opportunityService, SystemService) {
            ...
            $scope.allCustomersCount = $rootScope.globalDomainStats.allOpportunitiesCount;
            ...
            $scope.pageChanged = function(newPage) {
                ...
                $scope.customersPromise = opportunityService.getOpportunityByBuilder
