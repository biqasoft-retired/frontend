...
angular.module('app.token.new', ['ngRoute', 'LocalStorageModule'])
    ...
    .controller('DirectTokenCtrl', ['$scope', 'tokenService', '$location',
        function ($scope, tokenService, $location) {
            $scope.token = {};
    ...
    .controller('DirectTokenAllCtrl', ['$scope', 'tokenService',
    ...
    .controller('DirectTokenCampaignsHistory', ['$scope', 'allDirectCampaignsService', '$location', '$route',
        function ($scope, allDirectCampaignsService, $location, $route) {
    ...
    .controller('DirectTokenCampaigns', ['$scope', 'allDirectCampaignsService', '$location', '$route',
        function ($scope, allDirectCampaignsService, $location, $route) {
            $scope.tokenId = $route.current.params.id;
