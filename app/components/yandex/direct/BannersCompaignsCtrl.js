...
angular.module('app.yandex.banners', ['ngRoute', 'LocalStorageModule'])
    ...
    .controller('BannersCompaignsCtrl', ['$scope', '$route', 'allDirectCampaignsService',
        function ($scope, $route, allDirectCampaignsService) {
            $scope.allBanners = [];
    ...
    .controller('BannersCompaignsHistoryCtrl', ['$scope', '$route', 'allDirectCampaignsService',
        function ($scope, $route, allDirectCampaignsService) {
