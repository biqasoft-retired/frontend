...
angular.module('app.deals', ['ngRoute', 'LocalStorageModule'])
    .controller('CustomerDealAllCtrl', ['$scope', '$rootScope', 'LeadGenService', 'PaymentsService', 'SystemService',
        function($scope, $rootScope, LeadGenService, PaymentsService, SystemService) {
            ...
            $scope.allCustomersCount = $rootScope.globalDomainStats.allDealsCount;
            ...
            $scope.pageChanged = function(newPage) {
                ...
                $scope.customersPromise = PaymentsService.getDealsByBuilder
